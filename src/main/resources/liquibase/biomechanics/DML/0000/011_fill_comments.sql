...
INSERT INTO biomechanics."comments" ("text", user_id, term_id, create_date, edit_date)
VALUES ('Очень хорошее видео, мне понравилось!', 1, 1, CURRENT_DATE, CURRENT_DATE),
       ...
       ('Такие же ножница, только лучше.', 9, 8, CURRENT_DATE, CURRENT_DATE),
       ('Хлеборезка, но без хлеба.', 10, 8, CURRENT_DATE, CURRENT_DATE);
